...
Стояла цель написать MVP на Go с чистой архитектурой, без лишних зависимостей и сложной инфраструктуры. В качестве внешнего API используется REST с JSON, а в качестве хранилища — in-memory repository. Для интеграции с заведением используется Kafka.

Агенты которые использовались во время разработки:
Claude, ChatGPT, Github Copilot, ChatGPT Code Interpreter.

Задание сделано < 24 часа, поэтому в MVP не реализованы авторизация, платежи, доставка, полноценный Kafka broker-клиент и административное API.
